        ...
        if(cmd.getName().equalsIgnoreCase("GameMode")) {
            if(s instanceof Player p) {
                        ...
                        if(args[0].equalsIgnoreCase("0")||args[0].equalsIgnoreCase("survival")) {
                            if(args.length == 1) {
                                ...
                                if(Bukkit.getPlayer(args[1])!=null) {
                                    CreativeUser t = Main.creativeUsers.get(Objects.requireNonNull(Bukkit.getPlayer(args[1])).getUniqueId());
                ...
                if (s.hasPermission("zyneon.team")) {
                    if (args.length == 2) {
                        if (Bukkit.getPlayer(args[1]) != null) {
                            CreativeUser t = Main.creativeUsers.get(Bukkit.getPlayer(args[1]).getUniqueId());
                            if (args[0].equalsIgnoreCase("0") || args[0].equalsIgnoreCase("survival")) {
                                t.getPlayer().setGameMode(GameMode.SURVIVAL);
                                t.sendMessage("§7Du bist nun im §eSurvival§8-§eModus§8!");
                            } else if (args[0].equalsIgnoreCase("1") || args[0].equalsIgnoreCase("creative")) {
